...
class FigureCanvas(Canvas):
	...
	# FigureCanvas Class Object Constructor Initializer Method:
	def __init__(self, container, figureType, filled = False, width = 100, height = 100):
		...
		# FigureCanvas Class Object Data Attributes:
		self.__figureType = figureType
		self.__filled = filled
		
		# Calls the drawFigure FigureCanvas Class Object Method:
		self.drawFigure()

	# FigureCanvas Class Object Accessor Methods:
	...
	# FigureCanvas Class Object Mutator Methods:
	...
	# FigureCanvas Class Object Methods:
	def drawFigure(self):
